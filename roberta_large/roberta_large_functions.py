    ...
    for i, (train_idx, valid_idx) in enumerate(
        ...
        for epoch in range(EPOCHS):
            ...
            for step, data in enumerate(tbar_val):
                ...
                val_loss_list.append(loss.detach().cuda().item())
...
# todo: add logger,
#  add wandb tracking,
#  save tuned tokenizer,
#  save folds like abishek's notebook
#  consider using the cleaned up data,
#  hyperparameter tuning with optuna and wandb,
#  make all the transformer models consistent
